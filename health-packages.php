						...
						<div class="tp-section">
							...
							<div>
								<div class="tp-about__info-list ab-check-list mb-55 mt-15">
									<ul>
									   <li><i class="fa-solid fa-check"></i>CBC and HPLC test</li>
									   <li><i class="fa-solid fa-check"></i>PFT Test (Pulmonary Function Test)</li>
									   <li><i class="fa-solid fa-check"></i>Cholesterol and lipid profil</li>
									   <li><i class="fa-solid fa-check"></i> Chest X-rays, ECG tests and 2D
										echocardiography are all part of the cardiac system.</li>
										<li><i class="fa-solid fa-check"></i>Check your vitamins</li>
										<li><i class="fa-solid fa-check"></i>Cholesterol and lipid profil</li>
										<li><i class="fa-solid fa-check"></i> Abdominal Ultrasonography:
											Ultrasonography of abdomen and pelvis</li>
										<li><i class="fa-solid fa-check"></i>TSH, T3 and T4 thyroid function
											tests</li>
											<li><i class="fa-solid fa-check"></i> Kidney function test (KFT): urea,
												uric acid and serum creatinine</li>
											<li><i class="fa-solid fa-check"></i> SGPT, SGOT, and Serum Bilirubin:
												Liver Function Test (LFT)</li>
											<li><i class="fa-solid fa-check"></i> Diabetes screening: Fasting blood
												sugar and PP Hepatitis B test</li>
											<li><i class="fa-solid fa-check"></i>Calcium scoring in CT</li>
											<li><i class="fa-solid fa-check"></i>Total body fat percentage</li>
											<li><i class="fa-solid fa-check"></i>Check your eyes</li>
									</ul>
								 </div>
								
							</div>
							<p class=" mr-20 mb-35">In addition, some full body checkup packages in Navi Mumbai may also
								include additional tests such as Pap smear for women, PSA test for men and vitamin D and
								B12 tests. It is important to consult with a healthcare professional to understand what
								tests are needed based on individual health concerns and medical history. A full body
								checkup can be an effective way to detect health problems early and prevent or manage
								chronic diseases, making it an important aspect of overall health and wellness.</p>
						</div>
				...
				<div class="row wow fadeInUp" data-wow-delay=".3s"
					...
					<div class="col-lg-12">
						<div class="tp-cta-bg p-relative theme-light-bg pt-65 pb-70"
							data-background="assets/img/shape/shape-bg-04.png"
							style="background-image: url(&quot;assets/img/shape/shape-bg-04.png&quot;);">
							<div class="cta-content ml-90">
								<div class="row">
									<div class="col-lg-5">
										<h2 class="cta-title mb-30">Full Body Checkup At Navi Mumbai</h2>
										<p class="cta-para">A complete physical examination that diagnoses and carefully
											evaluates the health status of a healthy body is known as a comprehensive,
											complete physical examination. It helps in comprehensive assessment of all
											body systems and organs. It consists of various tests that provide
											information about a person's current health status. It includes more than 60
											tests to determine the health status of every body organ, including the
											thyroid, teeth, eyes, bones, liver, kidneys and more.</p>
									</div>
									<div class="col-lg-7">
							...
							<div class="accordion-items">
								<h2 class="accordion-header" id="headingOne">
									<button class="accordion-button" type="button" data-bs-toggle="collapse"
										...
										aria-controls="collapseOne">Who needed a Full Body Checkup? </button>
								</h2>
								<div id="collapseOne" class="accordion-collapse collapse show"
									aria-labelledby="headingOne" data-bs-parent="#accordionExample">
									<div class="accordion-content">
										<p>Anyone over the age of 25 who has not had a full body checkup delhi in the
											last 6-12 months and is interested in learning more about their health.</p>
									</div>
								</div>
							</div>
							<div class="accordion-items">
								<h2 class="accordion-header" id="headingTwo">
									<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
										...
										aria-controls="collapseTwo">How to Prepare for a Full Body Checkup? </button>
								</h2>
								<div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
									data-bs-parent="#accordionExample">
									<div class="accordion-content">
										<p>Make certain that you get enough sleep. Foods that are oily, hot, or salty
											should be avoided. Dinner should always include light fare. If you must
											fast, do so for 8-10 hours. Avoid drinking alcoholic beverages.</p>
									</div>
								</div>
							</div>
							<div class="accordion-items">
								<h2 class="accordion-header" id="headingThree">
									<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
										...
										aria-controls="collapseThree">What exactly is a routine health checkup?
									</button>
								</h2>
								<div id="collapseThree" class="accordion-collapse collapse"
									aria-labelledby="headingThree" data-bs-parent="#accordionExample">
									<div class="accordion-content">
										<p>A routine health checkup consists of a battery of medical tests designed to
											assess your overall health. A health checkup will typically include blood
											sugar, cholesterol, kidney, liver function, blood work, and thyroid tests.
											If any of the test results are abnormal, the doctor may recommend additional
											tests.</p>
									</div>
								</div>
							</div>
							<div class="accordion-items">
								<h2 class="accordion-header" id="headingFour">
									<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
										...
										aria-controls="collapseFour">What is the purpose of a Full Body Health Checkup?
									</button>
								</h2>
								<div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
									data-bs-parent="#accordionExample">
									<div class="accordion-content">
										<p>Full Body Health Checkups are important because they help detect early signs
											of illness, allowing the problem to be reversed or cured. Full Body Health
											Checkups are indicators of how your lifestyle choices affect your health,
											and they provide you with the information you need to make changes to live a
							...
							<div class="accordion-items">
								<h2 class="accordion-header" id="headingFive">
									<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
										...
										aria-controls="collapseFive">Why is a Full Body Checkup necessary? </button>
								</h2>
								<div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
									data-bs-parent="#accordionExample">
									<div class="accordion-content">
										<p>A regular body check-up can assist doctors in diagnosing a disease before it
											poses a high risk. Reduces the risk of treatment complications - When you
											are diagnosed with a health condition at an early stage, the complexity and
											risk involved are less than when you are diagnosed at a late stage.</p>
									</div>
								</div>
							</div>
							<div class="accordion-items">
								<h2 class="accordion-header" id="headingSix">
									<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
										...
										aria-controls="collapseSix">What exactly is a yearly full body checkup?
									</button>
								</h2>
								<div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
									data-bs-parent="#accordionExample">
									<div class="accordion-content">
										<p>Anyone over the age of 25 who has not had a full body checkup in the last
											6-12 months and is interested in learning more about their health.</p>
									</div>
								</div>
							</div>
							<div class="accordion-items">
								<h2 class="accordion-header" id="headingSeven">
									<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
										...
										aria-controls="collapseSeven">What is included in a full Body checkup? </button>
								</h2>
								<div id="collapseSeven" class="accordion-collapse collapse"
									aria-labelledby="headingSeven" data-bs-parent="#accordionExample">
									<div class="accordion-content">
										<p>Here is the list that includes:</p>
										<ol>
											<li>
												<p>Vitals Checkup:</p>
												<p>Your blood pressure, respiratory, temperature, and heart rate will be
													taken. Taking these vital checkups will help in identifying the
													actual problem.</p>
											</li>
											<li>
												<p>Physical checkup:</p>
												<p>Your physical checkups will also be done, some of the general
													checkups will include the heart (cardiovascular system), tummy
													(abdominal system), lungs (respiratory system), etc. These are the
													part of the body that manages the function of your body.</p>
											</li>
											<li>
												<p>Medical Tests:</p>
												<p>Medical Tests include liver functioning tests, kidney function tests,
													diabetes checks, thyroid function checks, and several other medical
													tests based on the symptoms.</p>
											</li>
										</ol>
									</div>
								</div>
							...
							<div class="accordion-items">
								<h2 class="accordion-header" id="headingEight">
									<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
										...
										aria-controls="collapseEight">How frequently should you perform a full body
										checkup? </button>
								</h2>
								<div id="collapseEight" class="accordion-collapse collapse"
									aria-labelledby="headingEight" data-bs-parent="#accordionExample">
									<div class="accordion-content">
										<p>Most people only get a full body checkup delhi when they have a minor or
											major medical emergency. However, a full body checkup delhi should be
											performed at least once every 6-12 months to ensure that you are immune to
											and avoid any future medical issues.</p>
									</div>
								</div>
							</div>
							<div class="accordion-items">
								<h2 class="accordion-header" id="headingNine">
									<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
										...
										aria-controls="collapseNine">What is the price of full body checkup? </button>
								</h2>
								<div id="collapseNine" class="accordion-collapse collapse" aria-labelledby="headingNine"
									data-bs-parent="#accordionExample">
									<div class="accordion-content">
										<p>Full body checkup price starts at ₹699. Full body checkup price can be
											different for different parameters or requirement of tests.</p>
									</div>
								</div>
							</div>
							<div class="accordion-items">
								<h2 class="accordion-header" id="headingTen">
									<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
										...
										aria-controls="collapseTen">What is a full body checkup home collection package?
									</button>
								</h2>
								<div id="collapseTen" class="accordion-collapse collapse" aria-labelledby="headingTen"
									data-bs-parent="#accordionExample">
									<div class="accordion-content">
										<p>A full body checkup home collection package is a comprehensive health checkup
											package that includes a range of tests to assess the overall health and
											wellness of an individual. The tests are usually performed on blood and
											urine samples collected from the individual, and the package may also
											include a physical examination.</p>
									</div>
								</div>
							</div>
							<div class="accordion-items">
								<h2 class="accordion-header" id="headingEleven">
									<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
										...
										aria-controls="collapseEleven">Is fasting required for a full body checkup home
										collection package? </button>
								</h2>
								<div id="collapseEleven" class="accordion-collapse collapse"
									aria-labelledby="headingEleven" data-bs-parent="#accordionExample">
									<div class="accordion-content">
										<p>Fasting may be required for some tests included in a full body checkup home
											collection package, such as tests for blood sugar and cholesterol. It is
											important to follow the instructions provided by the health service provider
											regarding fasting requirements and other preparations for the tests.</p>
									</div>
								</div>
							</div>
							<div class="accordion-items">
								<h2 class="accordion-header" id="headingTwelve">
									<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
										...
										aria-controls="collapseTwelve">How long does it take to receive the results of a
										full body checkup home collection package? </button>
								</h2>
								<div id="collapseTwelve" class="accordion-collapse collapse"
									aria-labelledby="headingTwelve" data-bs-parent="#accordionExample">
									<div class="accordion-content">
										<p>The time it takes to receive the results of a full body checkup home
											collection package may vary depending on the provider and the specific tests
											included in the package. Some providers may offer same-day or next-day
											results, while others may take several days or weeks to process the samples
											and generate the results. It is recommended to ask the provider about the
											expected turnaround time for the results.</p>
									</div>
								</div>
							</div>
						</div>
