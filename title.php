...
switch($title){
    case 'index.php':
        $title = "Forex Outsourcing Support Solutions | Outsourcing  Services";
        $description = "Get professional Forex Outsourcing Support Solutions from our team of experts. Our services include Live Chat, Email Desk, Remote Support, CRM, & many more";
    ...
    case 'contact-us.php':
        $title = "Contact Us | Get in touch with us | Forex Outsourcing Solutions";
    ...
    case 'privacy-policy.php':
        ...
        $url = "https://pravilabs.inprivacy-policy.php";
        break;
    ...
    case 'terms-and-conditions.php':
        ...
        $url = "https://pravilabs.interms-and-conditions.php";
        break;
